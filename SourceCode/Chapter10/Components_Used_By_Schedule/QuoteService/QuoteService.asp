...
Dim SoapServer
If Not Application("QuoteServiceInitialized") Then
  Application.Lock
  If Not Application("QuoteServiceInitialized") Then
    Dim WSDLFilePath
    Dim WSMLFilePath
    WSDLFilePath = Server.MapPath("QuoteService.wsdl")
    WSMLFilePath = Server.MapPath("QuoteService.wsml")
    ...
    Set Application("QuoteServiceServer") = SoapServer
    Application("QuoteServiceInitialized") = True
  End If
  Application.UnLock
End If
Set SoapServer = Application("QuoteServiceServer")
